...
public class HomeServiceImpl implements HomeService {
    ...
    public HomeContentResult content() {
        ...
        //获取人气推荐
        result.setHostProductList(homeDao.getHotProductList(0,4));
        //获取推荐专题
